...
contextBridge.exposeInMainWorld('api', {
  ...
  importShaderpack: (packKey, filePaths) => ipcRenderer.invoke('import-shaderpack', packKey, filePaths),
  ...
  saveGameOptions: (packKey, optionsObj) => ipcRenderer.invoke('save-game-options', packKey, optionsObj),
